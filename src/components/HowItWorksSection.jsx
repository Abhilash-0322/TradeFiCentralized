  ...
  const steps = [
    {
      ...
      description: 'Securely connect your Web3 wallet to our platform. We support MetaMask, WalletConnect, and more.',
      icon: <Shield size={24} />,
    },
    {
      number: 2,
    ...
    },
    {
      number: 3,
      title: 'Deposit Funds',
      description: 'Deposit your crypto assets into our smart contracts. Your funds remain under your control.',
      icon: <DollarSign size={24} />,
    },
    {
      number: 4,
      title: 'Let AI Do the Work',
      description: 'Our AI algorithms continuously monitor markets and execute trades for optimal returns.',
      icon: <Brain size={24} />,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Get started with DeFiAI in just a few simple steps
          </p>
        </div>
