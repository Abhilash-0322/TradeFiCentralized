...
const Footer = () => {
  const sections = [
    ...
    {
      title: "Resources",
      links: ["Help Center", "Community", "FAQs", "Guides", "Newsletter"],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              An AI-powered DeFi trading platform delivering institutional-grade algorithms to individual investors.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            {["Terms of Use", "Privacy Policy", "Cookie Policy"].map((link, index) => (
